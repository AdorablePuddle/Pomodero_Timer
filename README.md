# Pomodero Timer with Python
## I. How to use
This project comes with its own python virtual environment. In order to run the program, simply open a command prompt within this folder and run:
```
